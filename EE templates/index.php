...
<div id="loader">xxxxxxxxxxxxx</div>
...
{/exp:channel:entries}
		...
		{exp:channel:entries channel="article" category_group="1" dynamic="no" sort="asc"}
			...
			{/exp:channel_images:images}
				...
				<div class="overbox">
					<div class="text-wrap">
						<a href="{site_url}index.php/base/posts/{url_title}" class="post-link" title="{url_title}">{title}</a>
						<a href="{site_url}index.php/base/posts/{url_title}" class="post-link" title="{url_title}">{article_text}</a>
					</div>
					<div class="icon-wrap">
